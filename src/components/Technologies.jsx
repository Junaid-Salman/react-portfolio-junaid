...
import { SiMongodb, SiPython, SiNestjs, SiPostgresql } from "react-icons/si";
        ...
        <div className="border-b border-neutral-800 pb-24">
            ...
            <motion.div
                ...
                <motion.div
                    ...
                    animate="animate"
                    className="rounded-2xl border-4 border-neutral-800 p-4">
                    <SiNestjs className="text-6xl text-red-600" />
                </motion.div>
                ...
                <motion.div
                    ...
                    animate="animate"
                    className="rounded-2xl border-4 border-neutral-800 p-4">
                    <SiPostgresql className="text-6xl text-blue-600" />
                </motion.div>
            </motion.div>
        </div>
    )
